...
const showAdminDeleteModal = (currUserUID: any, adminAccount: any) => {
  confirm({
...
const EditAdminModal = ({ open, admin, setVisible }: any) => {
...
const SingleAdminAccountCard = ({ admin }: any) => {
